...
package com.atwbin.orderdemo.view.roundedimageview;
...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCornerRadii[RoundedDrawable.CORNER_TOP_LEFT] = a
                .getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius_top_left, -1);
        mCornerRadii[RoundedDrawable.CORNER_TOP_RIGHT] = a
        ...
        mCornerRadii[RoundedDrawable.CORNER_BOTTOM_LEFT] = a
    ...
    public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
        if (mCornerRadii[RoundedDrawable.CORNER_TOP_LEFT] == topLeft && mCornerRadii[RoundedDrawable
                .CORNER_TOP_RIGHT] == topRight && mCornerRadii[RoundedDrawable.CORNER_BOTTOM_RIGHT] == bottomRight &&
